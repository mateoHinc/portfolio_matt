...
export const SKILLS = [
  ...
  { name: "Node.js", level: 10, logo: "/logos/nodejs.svg" },
  { name: "PHP", level: 65, logo: "/logos/php.svg" },
  { name: "Laravel", level: 40, logo: "/logos/laravel.svg" },
  { name: "Python", level: 40, logo: "/logos/python.svg" },
  { name: "FastAPI", level: 25, logo: "/logos/fastapi.svg" },
  { name: "Java", level: 30, logo: "/logos/java.svg" },
  { name: "Spring Boot", level: 30, logo: "/logos/springboot.svg" },
  ...
  { name: "Docker", level: 20, logo: "/logos/docker.svg" },
