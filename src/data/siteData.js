...
export const SKILLS = [
  { name: "HTML", level: 70, logo: "/public/logos/html.svg" },
  { name: "Javascript", level: 50, logo: "/public/logos/html.svg" },
  { name: "CSS3", level: 50, logo: "/public/logos/css3.svg" },
  { name: "PHP", level: 65, logo: "/public/logos/php.svg" },
  { name: "Python", level: 50, logo: "/public/logos/python.svg" },
  { name: "Java", level: 55, logo: "/public/logos/java.svg" },
  { name: "TypeScript", level: 45, logo: "/public/logos/typescript.svg" },
  { name: "Bootstrap", level: 55, logo: "/public/logos/bootstrap.svg" },
  { name: "Vue JS", level: 55, logo: "/public/logos/vue.svg" },
  { name: "React JS", level: 55, logo: "/public/logos/react.svg" },
  { name: "Angular", level: 40, logo: "/public/logos/angular.svg" },
  { name: "Tainwind CSS", level: 55, logo: "/public/logos/tailwind.svg" },
  { name: "Git", level: 45, logo: "/public/logos/git.svg" },
  { name: "Linux", level: 30, logo: "/public/logos/linux.svg" },
  { name: "MySQL", level: 50, logo: "/public/logos/mysql.svg" },
  { name: "SQL Server", level: 50, logo: "/public/logos/sql.svg" },
  { name: "Word", level: 75, logo: "/public/logos/word.svg" },
  { name: "Excel", level: 75, logo: "/public/logos/excel.svg" },
  { name: "Power Point", level: 75, logo: "/public/logos/powerpoint.svg" },
];
